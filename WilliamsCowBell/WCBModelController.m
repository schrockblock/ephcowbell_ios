...
@interface WCBModelController()
@property (readonly, strong, nonatomic) NSArray *pageData;
@end

@implementation WCBModelController
...
{   
    ...
    WCBDataViewController *dataViewController = [storyboard instantiateViewControllerWithIdentifier:@"WCBDataViewController"];
...
{
    NSUInteger index = [self indexOfViewController:(WCBDataViewController *)viewController];
